...
\begin{frame}{\textit{meta-melingo}}
  \begin{itemize}
    ...
    \item \structure{Features}
      ...
      \item Intervals are translated using linear constraints via \flingo, \clingodl and \clingcon
      \item Integrated \clingraph\ visualization for traces
      \end{itemize}
    \item \structure{Technology} \ \clingo\ Meta-programming, \flingo, \clingodl, \clingcon, \clingraph
  \end{itemize}
\end{frame}
% ----------------------------------------------------------------------
%
